...
import { Box, Button, Container, Grid, Pagination,  OutlinedInput, InputLabel, MenuItem, FormControl, Select} from '@mui/material';
import { createTheme, ThemeProvider } from '@mui/material/styles';
import { Favorite, FavoriteBorder } from '@mui/icons-material';
import {useSelector, useDispatch} from 'react-redux'
import { buscarProducto, getAllCategorias, getAllProducts, limpiarFiltroyBusqueda, aplicarFiltros, getDetail } from '../../Redux/actions';
  ...
  var botonCat = []
    ...
    const arrayCats = ()=>{
      ...
      categorias.forEach(cate=>{
        if(!array.includes(cate.nombrecat))
        array.push(cate.nombrecat)
      })
      return array
    }
